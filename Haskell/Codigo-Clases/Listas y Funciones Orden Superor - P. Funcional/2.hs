...
frecuenciaCardiaca = [80, 100, 120, 128, 130, 123, 125]Comienza con un frecuencia de 80 min 0.
...
b. Definir la función frecuenciaCardiacaMinuto/1, que recibe m que es el minuto en el cual quiero conocer la
...
-- / necesita recibir fractionals

-- fromIntegral pasa de integral a Num, que es más abarcativo y lo elije a conveniencia

minutox10 num = div num 10

frecuenciaCardiacaMinuto min lista = lista !! (minutox10 min)

-- !! te saca la n posicion de la lista

-- (integer, [integer]) => Integer -> [integer] -> [integer]
frecuenciasHastaMomento momento lista = take ((fromIntegral . minutox10) momento) lista

-- take recibe un int por lo que utilizo fromIntegral para cambiar lo a Num a, que es más abarcativo y me lo acomoda a conveniencia