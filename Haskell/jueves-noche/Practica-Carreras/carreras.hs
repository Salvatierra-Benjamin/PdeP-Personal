...
leEstaGanando unAuto  = (< distanciaRecorrida unAuto) . distanciaRecorrida -- * Tengo que borrar el argumento

noTieneNadieCerca :: Auto -> Carrera -> Bool
-- noTieneNadieCerca auto carrera = not ( any (estaCerca auto) carrera) 
noTieneNadieCerca auto = not . any (estaCerca auto) -- * Tengo que borrar el argumento
